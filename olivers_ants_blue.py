...
def print_grid(grid):
  ...
  for row in grid:
    for e in row:
      ...
      if(e==1):print(Fore.LIGHTBLUE_EX + '1', end='') # end='' removes newline
      if(e==2):print(Fore.LIGHTBLACK_EX + '2', end='') # 
      if(e==3):print(Fore.BLACK + '3', end='') # 
      if(e==4):print(Fore.BLUE + '4', end='') # 
            
      if(e==11):print(Fore.LIGHTBLUE_EX + '%', end='') # 
      if(e==12):print(Fore.LIGHTBLACK_EX + '#', end='') # 
      if(e==13):print(Fore.BLACK + '@', end='') # 
      if(e==14):print(Fore.BLUE + '&', end='') # 
...
# range of 25 ends 80,000 generations to 2,000,000
